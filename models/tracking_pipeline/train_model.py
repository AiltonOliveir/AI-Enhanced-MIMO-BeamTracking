...
from src.hybrid_model import tracking_model
...
if __name__ == "__main__":
    ...
    model = tracking_model(
        ...
        window_length=cfg.DataGenerator.window_size,
    ...
    model_checkpoint_callback = ModelCheckpoint(
        filepath=f"models/{cfg.model_name}_epochs_{cfg.epochs}_tracking.weights.h5",
    ...
    with open('tracking_training_history.json', 'w') as f:
